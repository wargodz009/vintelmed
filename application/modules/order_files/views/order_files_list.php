			...
			<table class="datatable">
				...
				<tbody>
					...
					<tr>
						...
						<td><a href="<?php echo base_url();?>order_files/delete/<?php echo $c->order_files_id;?>" class="confirm" rel="Are you sure you want to delete <?php echo $c->file_name;?>?">Delete</a></td>
					</tr>
					<?php
						}
					} else {
